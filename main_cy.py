...
TRAIN_LIST_PATH = './info/train_filelist_flickr.txt'
...
trainset = Webvisiondata(TRAIN_LIST_PATH,transform=transform_train)
train_loader = torch.utils.data.DataLoader(
    trainset, batch_size=BATCH_SZIE, shuffle=None, num_workers=2)

testset =Webvisiondata(VALID_LIST_PATH, transform=transform_test)
